...
//#define CPU_FL_CF(cpu)	cpu->cf
//#define CPU_FL_PF(cpu)	cpu->pf
//#define CPU_FL_AF(cpu)	cpu->af
//#define CPU_FL_ZF(cpu)	cpu->zf
//#define CPU_FL_SF(cpu)	cpu->sf
//#define CPU_FL_TF(cpu)	cpu->tf
//#define CPU_FL_IFL(cpu)	cpu->ifl
//#define CPU_FL_DF(cpu)	cpu->df
//#define CPU_FL_OF(cpu)	cpu->of
//
