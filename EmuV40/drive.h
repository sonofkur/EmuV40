...
//typedef int (*drive_read_func)(void*, void* cb_ptr, void* buffer, uint32_t size, drv_offset_t offset, drive_cb cb);
//typedef int (*drive_write_func)(void*, void* cb_ptr, void* buffer, uint32_t size, drv_offset_t offset, drive_cb cb);
//typedef int (*drive_prefetch_func)(void*, void* cb_ptr, uint32_t size, drv_offset_t offset, drive_cb cb);
//
//struct drive_info {
