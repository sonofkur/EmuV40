...
//uint32_t get_and_inc_address(uint8_t sel, bool write);
//static void video_space_read_range(uint8_t* dest, uint32_t address, uint32_t size);
//
//
//
...
//	SDL_CreateWindowAndRenderer((int)(SCREEN_WIDTH * window_scale * screen_x_scale), (int)(SCREEN_HEIGHT * window_scale), window_flags, &window, &renderer);
//	SDL_SetWindowResizable(window, true);
//	SDL_RenderSetLogicalSize(renderer, (int)(SCREEN_WIDTH * screen_x_scale), SCREEN_HEIGHT);
//
...
//	vga_scan_pos_x += (float)(PIXEL_FREQ * steps / mhz);
...
//		}
//	}
//	ntsc_half_cnt += (float)(PIXEL_FREQ * steps / mhz);
...
//	case 0x02: return (io_addr[io_addrsel] >> 16) | (0 << 1) | (0 << 2) | (io_inc[io_addrsel] << 3);
//	case 0x03:
//	case 0x04:
//	{
//		/*if (debugOn) {
...
//
//	case 0x1E:
//		return joystick_get_buttons(0);
//	case 0x1F:
//		return joystick_get_buttons(1);
//	}
//	return 0;
//}
//
...
////	vera_write(0, addr & 0x00);
////	vera_write(1, (addr >> 8) & 0x00);
...
////	}
////
////	vera_write(0, addr & 0xFF);
////	vera_write(1, (addr >> 8) & 0xFF);
////	vera_write(2, 0b00010001);
////	for (int c = 0; c < 128; c++) {
////		for (int i = 0; i < 8; i++) {
////			vera_write(3, default_font[c * 8 + i]);
////		}
////	}
////
////	vera_write(0x09, 0b00010001);
////	vera_write(0x0A, 64);
////	vera_write(0x0B, 64);
////	vera_write(0x0D, 0b01100000);
////	vera_write(0x0E, 0b00000000);
////	vera_write(0x0F, 0b11111000);
////	vera_write(0x10, 0);
////	vera_write(0x11, 0);
////	vera_write(0x12, 0);
////	vera_write(0x13, 0);
